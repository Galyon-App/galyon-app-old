...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'dashboard',
        loadChildren: () => import('./merchant/dashboard/dashboard.module').then(m => m.DashboardModule),
      },
      {
        path: 'stats',
        loadChildren: () => import('./merchant/stats/stats.module').then(m => m.StatsModule)
      },

      {
        path: 'manage-orders',
        loadChildren: () => import('./merchant/manage-orders/manage-orders.module').then(m => m.ManageOrdersModule)
      },
      {
        path: 'contacts',
        loadChildren: () => import('./merchant/contacts/contacts.module').then(m => m.ContactsModule)
      },
      {
        path: 'products',
        loadChildren: () => import('./merchant/products/products.module').then(m => m.ProductsModule)
      },
      {
        path: 'manage-products',
        loadChildren: () => import('./merchant/manage-products/manage-products.module').then(m => m.ManageProductsModule)
      },
      {
        path: 'reviews',
        loadChildren: () => import('./merchant/reviews/reviews.module').then(m => m.ReviewsModule)
      },
    ],
    canActivate: [AuthGuard],
  ...
  {
    path: 'reset',
    loadChildren: () => import('./merchant/reset/reset.module').then(m => m.ResetModule)
  },
