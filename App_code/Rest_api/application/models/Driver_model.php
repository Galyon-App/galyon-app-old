...
class Driver_model extends Main_model
{
   ...
   public function login($user_data){
    ...
    public function sendBulk($to_address,$message,$subject){
        ...
        $this->email->clear();
        $this->email->from('suppport@bytescrafter.net');
        $this->email->reply_to('noreply@bytescrafter.net');
    ...
    public function verificationLink($email,$url){
        $this->load->library('email');
        $this->email->clear();
        $this->email->from('support@bytescrafter.net');
        $this->email->reply_to('noreply@bytescrafter.net');
        $this->email->to($email);
