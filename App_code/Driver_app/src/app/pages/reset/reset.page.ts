...
export class ResetPage implements OnInit {
  ...
  sendOTP() {
    ...
    this.api.post('drivers/sendOTP', param).subscribe((data: any) => {
      console.log(data);
      this.loggedIn = false;
  ...
  sendEmail() {
    ...
    this.loggedIn = true;
    this.api.post('drivers/update_password', param).subscribe((data: any) => {
      console.log(data);
      this.loggedIn = false;
      if (data && data.status === 200) {
        this.loggedIn = false;
  ...
  resetPasswordWithPhone() {
    ...
    this.loggedIn = true;
    this.api.post('drivers/resetPasswordWithPhone', param).subscribe((data: any) => {
      console.log(data);
      this.loggedIn = false;
      if (data && data.status === 200) {
        this.loggedIn = false;
  ...
  sendOTPOnMobile() {
    ...
    this.loggedIn = true;
    this.api.post('drivers/validatePhoneForReset', param).subscribe((data: any) => {
      this.loggedIn = false;
